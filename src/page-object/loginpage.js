...
var loginpage = (function () {
    function loginpage() {
        this.uname = protractor_1.element(protractor_1.by.id('mat-input-0'));
        this.pass = protractor_1.element(protractor_1.by.id('mat-input-1'));
        this.login = protractor_1.element(protractor_1.by.buttonText('Login'));
    }
    loginpage.prototype.setUsername = function (user) {
